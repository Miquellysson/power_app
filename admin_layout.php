...
function admin_header($title='Admin'){
  ...
  echo '<a class="btn ghost" href="admin.php?route=settings"><i class="fa-solid fa-gear"></i><span>Config</span></a>';
  echo '<a class="btn ghost" href="index.php" target="_blank"><i class="fa-solid fa-store"></i><span>Loja</span></a>';
  echo '<a class="btn ghost" href="admin.php?route=logout"><i class="fa-solid fa-right-from-bracket"></i><span>Sair</span></a>';
  echo '</div></div></header>';
  // Layout: sidebar + main
