...
echo '<div class="p-3 row gap"><form class="row gap search"><input class="input" name="q" value="'.sanitize_html($q).'" placeholder="Buscar por nome/e-mail/telefone"><button class="btn" type="submit"><i class="fa-solid fa-magnifying-glass"></i> Buscar</button></form></div>';
...
foreach($st as $c){
  ...
  echo '<td><a class="btn" href="customers.php?action=view&id='.(int)$c['id'].'"><i class="fa-solid fa-eye"></i> Ver</a></td>';
  echo '</tr>';
}
echo '</tbody></table></div></div>';
admin_footer();
